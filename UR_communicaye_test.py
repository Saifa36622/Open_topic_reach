...
def PickAndPlace():
    ...
    p1 = [1.57, -math.pi/2, math.pi/2, 0.0, math.pi/2, 0.0]
    p2 = [0.0, -math.pi/2, math.pi/2, 0.0, math.pi/2, 0.0]

    # Pick 

    # print("begin move")
    ur_control.move_directly(p1, a=1.4, v=1.05, t=0, r=0) # move to p1_home
    ur_control.move_directly(p2, a=1.4, v=1.05, t=0, r=0) # move to p1_home
    # print("done move")
